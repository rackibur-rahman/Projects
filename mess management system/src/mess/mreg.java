...
Connection conn=null;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("খাবার ব্যবস্থাপনা");
    ...
    try{
        ...
        ps=conn.prepareStatement("insert into  add_member values(?,?,?,?)");
        ...
        if(i>0){
            JOptionPane.showMessageDialog(null,"New Member Registration is Successfull");
        }
        else{
            JOptionPane.showMessageDialog(null,"New Member Registration isn't Successfull");
        }
    }
    catch(Exception e)
                {
