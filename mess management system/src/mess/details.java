...
public void latext(){
    conn = MySqlConnect.ConnectDB();    
    String a3="SELECT SUM(`house_rent`+eletro_bill+gas_bill+net_bill+others) FROM `hrent`";
        ...
        try{
           ...
           result3=ps3.executeQuery();
           while(result3.next()){
               jLabel9.setText(result3.getString("SUM(`house_rent`+eletro_bill+gas_bill+net_bill+others)"));
               //jLabel7.setText(result1.getString("sum(expense.cost)"));
           }
...
public void lbtext(){
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Total Paid Balance");
        ...
        jButton3.setText("Total Expense");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("House Rent"));
        ...
        jButton9.setText("Per Person Cost");
       ...
       //conn = MySqlConnect.ConnectDB();
        ...
        try{
            if( rs.next()){
              ...
              JOptionPane.showMessageDialog(null, "Didn't Eat Any Meal");  
            }
        ...
        try{
            if( rs1.next()){
              ...
              JOptionPane.showMessageDialog(null, "Didn't Pay any Balance");  
            }
